...
var uheesister = {
    ...
    review : "발색샷이 모여있는 서비스가 좋은것은 맞다. 하지만 킬러가 되기에는 부족하다. 리뷰, 사용성 등의 다양한 정보가 반드시 뒷바침 되어야한다.",
...
var StartupLap= {
    ...
    reason : "StartupLap을 통해 How to start a startup 동영상을 시청하고 있었는데,  전체 스크립트를 비교하면서 동영상을 시청하는 것이 불편하다고 생각. 전체 스크립트의 싱크를 맞출 수 있는 프로그램을 만들어 전달하면 보는사람들이 편할 것 같아서 ",
    review : "-",
